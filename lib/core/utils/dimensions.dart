...
class Dimensions{
  ...
  static const double textFieldToTextFieldSpace = 20.00;
  ...
  static const EdgeInsets defaultScreenPadding = EdgeInsets.symmetric(horizontal: screenPaddingH, vertical: screenPaddingV);
